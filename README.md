...
### 20. 管理员报销池状态（admin:reimbursement_pool）
...
### 21. 管理员抽奖状态总览（admin:lottery_status）
...
### 24. 用户「📜 搜索历史」（user:search_history）增强
