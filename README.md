...
- 主菜单精简：super 6 → 4 行；非 super 5 → 3 行
...
### 21. 管理员报销池状态（admin:reimbursement_pool）
...
### 22. 管理员抽奖状态总览（admin:lottery_status）
...
### 25. 用户「📜 搜索历史」（user:search_history）增强
