...
- 报销池设置 / 报销功能开关（`system:reimburse_pool` / `system:reimburse_toggle`）属于系统设置子菜单，不在此聚合
...
### 19. 管理员报销池状态（admin:reimbursement_pool）
...
### 20. 管理员抽奖状态总览（admin:lottery_status）
...
### 23. 用户「📜 搜索历史」（user:search_history）增强
